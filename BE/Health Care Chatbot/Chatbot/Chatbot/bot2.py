...
GREETING_RESPONSES = ["Hi,are you suffering from any health issues?(Y/N)", "hey,are you having any health issues?(Y/N)", "Hi, there,are you having any health issues?(Y/N)", "hi there,are you having any health issues?(Y/N)", "hello,are you having any health issues?(Y/N)", "I am glad! You are talking to me,are you having any health issues?(Y/N)"]
Basic_Q = ("yes","y")
Basic_Ans = "Okay,tell me about your symptoms!"
Basic_Om = ("no","n")
Basic_AnsM = "Thank you, do visit again!"
fev=("I am suffering from fever", "I am affected with fever","I have fever","fever")
feve_r=("Any other physical issue, in order to get the clear idea of what exactly are you suffering from?")
